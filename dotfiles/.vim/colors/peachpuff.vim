...
hi Comment term=italic ctermfg=4 guifg=#406090
hi Entity term=bold ctermfg=6 guifg=#44AAAA 
hi String term=bold ctermfg=1 guifg=#c00058
hi Support term=bold ctermfg=2
